...
struct AppRouterTests {
    ...
    func adaptiveShellSourceContract() throws {
        ...
        #expect(studentDetailSource.contains("router.setActiveStudent(student)"))
        #expect(!studentDetailSource.contains("showingEditStudent"))
        #expect(quickActionsSource.contains("router.open(student)"))
