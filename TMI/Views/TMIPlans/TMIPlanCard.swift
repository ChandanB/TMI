            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(spacing: 16) {
                    ...
                    ProgressView(value: plan.progress)
                        .progressViewStyle(GlowingProgressStyle(color: modelColor))
...
struct GlowingProgressStyle: ProgressViewStyle {
    var color: Color
    ...
    func makeBody(configuration: Configuration) -> some View {
        ...
        .frame(height: 6) // Set the height for the GeometryReader
    }
}
...
struct StudentAvatarView: View {
    ...
    private var placeholderAvatar: some View {
        ZStack {
            Circle()
                .fill(student.avatarColor == .blue ? Color.blue :
