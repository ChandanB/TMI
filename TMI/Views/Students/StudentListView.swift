                        ...
                        Menu {
                            ForEach(FilterOption.allCases) { option in
                                Button(action: {
                                    ...
                                    Label(option.rawValue, systemImage: option == selectedFilterOption ? "checkmark.circle.fill" : "circle")
                                }
                            }
                            ...
                            .background(
                                RoundedRectangle(cornerRadius: 12)
                                    .fill(selectedFilterOption == .all ? Color.clear : Color.tmiSecondary.opacity(0.3))
                            )
                        }
                    }
                }
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack {
                    Circle()
                        .fill(student.tmiPlans?.isEmpty == false ? Color.green : Color.orange)
                        .frame(width: 8, height: 8)
                    
                    Text(student.tmiPlans?.isEmpty == false ? "Active TMI Plan" : "No Active Plan")
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: 24) {
                        ...
                        .animation(.easeInOut(duration: 0.2), value: name.isEmpty || grade.isEmpty || studentID.isEmpty)
                        .padding(.top, 10)
                    }
                    .padding(24)
                }
...
struct FilterOptionCard: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .shadow(color: isSelected ? Color.tmiSecondary.opacity(0.2) : Color.clear, radius: 10, x: 0, y: 5)
...
struct EnhancedStudentDetailView: View {
    ...
    private func emptyStateView(icon: String, title: String, message: String, buttonTitle: String, action: @escaping () -> Void) -> some View {
        VStack(spacing: 20) {
            Image(systemName: icon)
                .font(.system(size: 50))
                .foregroundColor(.white.opacity(0.5))
