...
// MARK: - Enhanced Audit Service

@Observable
final class EnhancedAuditService {

  // MARK: - Dependencies
  private let firestore: Firestore
  private let deviceInfoProvider: EnhancedDeviceInfoProvider
  ...
  init(
    ...
    deviceInfoProvider: EnhancedDeviceInfoProvider = EnhancedDeviceInfoProvider()
  ) {
...
class EnhancedDeviceInfoProvider {
...
let ENHANCED_AUDIT_SERVICE = EnhancedAuditService()
