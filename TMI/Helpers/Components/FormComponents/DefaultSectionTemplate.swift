...
struct DefaultSectionTemplates {
    ...
    static let address = FormSection(
        ...
        fields: [
            ...
            FormField(id: UUID().uuidString, label: "Postal Code", type: .text, isRequired: true, validationRules: [
    ...
    static let emergencyContact = FormSection(
        ...
        fields: [
            ...
            FormField(id: UUID().uuidString, label: "Relationship to Student", type: .text, isRequired: true),
            FormField(id: UUID().uuidString, label: "Emergency Contact Phone", type: .phoneNumber, isRequired: true, validationRules: [
            ...
            FormField(id: UUID().uuidString, label: "Email Address", type: .email, isRequired: true, validationRules: [
    ...
    static let photoConsent = FormSection(
        ...
        fields: [
            ...
            FormField(id: UUID().uuidString, label: "I agree to the Terms and Conditions", type: .checkbox, isRequired: true, validationRules: [
    ...
    static let employmentHistory = FormSection(
        ...
        fields: [
            FormField(id: UUID().uuidString, label: "Most Recent Job Title", type: .text, isRequired: true)
        ]
    )
    ...
    static let educationBackground = FormSection(
        ...
        fields: [
            FormField(id: UUID().uuidString, label: "Highest Level of Education", type: .dropdown, isRequired: true, options: ["High School", "Associate's", "Bachelor's", "Master's", "Doctorate", "Other"])
        ]
    )
    ...
    static let fileUpload = FormSection(
        ...
        title: "File Upload",
        fields: [
            FormField(id: UUID().uuidString, label: "Cover Letter (optional)", type: .file, isRequired: false),
    ...
    static let declaration = FormSection(
        ...
        title: "Declaration",
        fields: [
            FormField(id: UUID().uuidString, label: "I declare that the information provided is true and complete to the best of my knowledge.", type: .checkbox, isRequired: true, validationRules: [
